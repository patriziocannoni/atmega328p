...
// Function Prototypes
static void lcd_write_4(uint8_t);
static void lcd_write_instruction_4d(uint8_t);
static void lcd_write_character_4d(uint8_t);
static void lcd_write_string_4d(uint8_t *);
static void lcd_init_4d(void);
...
/**
 * Escreve uma sequencia de caracteres no LCD, a partir da linha e coluna especificada.
 */
void escreverLCD(LCDMessage* lcdMessage) {
	lcd_write_instruction_4d(lcdMessage->line + lcdMessage->column);
	_delay_us(80);
	lcd_write_string_4d(lcdMessage->pcMessage);
}
...
; Purpose:  display a string of characters on the LCD
  ...
  Notes:    uses time delays rather than checking the busy flag
*/
static void lcd_write_string_4d(uint8_t theString[]) {
...
static void lcd_write_character_4d(uint8_t theData) {
